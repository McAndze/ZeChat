...
//	}
	...
	public Channel(String name, NaviaChat plugin){
		this.name = name;
		this.plugin = plugin;
		this.banned = new ArrayList<String>();
	...
	public void initialize(){
		this.danAndLogger = new NaviaLogger(this.plugin, this);
	...
	public NaviaLogger getChLogger() {
		return danAndLogger;
	}

	public void setChLogger(NaviaLogger chLogger) {
