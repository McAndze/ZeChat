...
//public class NaviaPlayer {
//	public static List<NaviaPlayer> players = new ArrayList<NaviaPlayer>();
//	public static NaviaPlayer getDACPlayer(Player player){
//		for (NaviaPlayer dPlayer: players){
...
//	
//	public NaviaPlayer(Player player){
//		this.player = player;
